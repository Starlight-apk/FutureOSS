...
# NebulaShell 官方公钥
NEBULASHELL_PUBLIC_KEY_PEM = """-----BEGIN PUBLIC KEY-----
...
class SignatureVerifier:
    ...
    def _load_builtin_keys(self):
        ...
        # NebulaShell 官方公钥
        self.public_keys["NebulaShell"] = NEBULASHELL_PUBLIC_KEY_PEM.encode()
        # 加载额外密钥
    ...
    def is_official_plugin(self, plugin_dir: Path) -> bool:
        """检查是否是官方插件（Falck 或 NebulaShell 签名）"""
        return self.verify_plugin(plugin_dir, "Falck")[0] or \
               self.verify_plugin(plugin_dir, "NebulaShell")[0]
